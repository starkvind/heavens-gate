...
<?php if (function_exists('hg_page_register_stylesheet')) { hg_page_register_stylesheet('/assets/css/pages/legacy/controllers-chapters-season_order.css'); } else { ?><link rel="stylesheet" href="/assets/css/pages/legacy/controllers-chapters-season_order.css"><?php } ?>

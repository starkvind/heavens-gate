...
$query = "SELECT * FROM dim_traits WHERE id = ?";
...
if ($result->num_rows > 0) {
    while ($ResultQuery = $result->fetch_assoc()) {
        ...
        setMetaFromPage($nameSkill . " | Rasgos | Heaven's Gate", meta_excerpt($infoSkill), null, 'article');
        ...
        // Tipo de rasgo
        echo "<div class='renglonDonIz'>Tipo de rasgo:</div>"; 
        echo "<div class='renglonDonDe'>$typeSkill</div>";

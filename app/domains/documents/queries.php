...
if (!function_exists('hg_documents_has_table')) {
    function hg_documents_has_table(mysqli $link, string $table): bool
    {
        static $tables = [
            ...
            'dim_bibliographies' => true,
            'dim_character_status' => true,
            'dim_doc_categories' => true,
...
if (!function_exists('hg_documents_has_column')) {
    ...
    {
        static $schema = [
            'bridge_characters_docs' => ['sort_order'],
            'dim_doc_categories' => ['sort_order'],
            'fact_characters' => ['alias', 'character_kind', 'gender', 'image_url', 'status_id'],
            'fact_docs' => ['bibliography_id', 'pretty_id', 'section_id', 'source'],
        ];

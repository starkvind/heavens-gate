...
function hg_gcr_default_catalog(): array
{
    ...
    $settings = [
        ...
        ['work_mnemones_per_unique', '10', 'int', 'Tope de Mnemones por carta unica en coleccion.'],
    ...
    $uiTexts = [
        ...
        ['status.memory_cap_reached', 'Has alcanzado el tope de Mnemones acumulados por rememoración para tu colección actual.', 'Tope de rememoración alcanzado.'],
        ...
        ['shop.free_group', 'Protocolos de gratuidad', 'Grupo tienda gratis.'],
        ['shop.free_pack_name', 'Dispensador mnemónico', 'Nombre del sobre gratis.'],
        ['shop.daily_gift_name', 'Emisión ritual diaria', 'Nombre regalo diario.'],
        ...
        ['shop.free_pack_description', 'Canal gratuito: reclama hasta {cap} sobres mnemónicos al día.', 'Descripción sobre gratis.'],
        ['shop.free_pack_title', 'Dispensador mnemónico. Quedan {remaining} reclamaciones hoy.', 'Título sobre gratis.'],
        ['shop.pack_title', '{pack}: {description} Precio: {price} Mnemones.', 'Título sobre.'],
        ['shop.free_pack_buy_title', 'Reclamar {amount} sobre(s) del dispensador mnemónico', 'Título botón sobre gratis.'],
        ...
        ['combat.daily_risk_log', 'Solo las cartas derrotadas durante este desafío se pierden.', 'Riesgo jefe diario.'],
        ...
        ['combat.daily_destroy_team_log', 'Cartas derrotadas por el Jefe diario y perdidas: {count}.', 'Log equipo consumido.'],
        ['combat.daily_defeat_casualties', 'Derrota contra el Jefe diario. Cartas derrotadas perdidas: {count}.', 'Derrota jefe con bajas.'],
        ...
        ['combat.daily_team_lost_text', 'Cartas derrotadas perdidas: {count}.', 'Texto equipo perdido.'],
        ['combat.daily_team_safe_text', 'No se perdió ninguna carta de tu colección en este intento.', 'Texto intento sin pérdidas.'],

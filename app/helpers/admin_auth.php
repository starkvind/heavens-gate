...
if (!function_exists('hg_admin_login_return_path')) {
    ...
    function hg_admin_login_return_path(?string $candidate = null): string
    {
        ...
        $allowedSections = [
            'admin_characters', 'admin_avatar_mass', 'admin_characters_worlds',
            'admin_character_deaths', 'admin_characters_clone', 'admin_groups', 'admin_organizations',
            'admin_seasons', 'admin_season_order', 'admin_season_order_schema',
            ...
            'admin_gallery', 'admin_parties', 'admin_powers', 'admin_gift_image_mass',

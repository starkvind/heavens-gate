...
if (!function_exists('hg_admin_section_registry')) {
    function hg_admin_section_registry(): array
    {
        return [
            ...
            'admin_sim_character_talk' => ['target' => 'admin_sim_character_talk.php', 'normal' => true, 'ajax' => true],
            'admin_sim_browser' => ['target' => 'admin_sim_browser.php', 'normal' => true, 'ajax' => true],
            ...
            'admin_game_cards' => ['target' => 'admin_game_cards.php', 'normal' => true, 'ajax' => true],

<div style="position:absolute;font-size:9px;">
	<?php
		...
		$systemSeresSobrenaturales = "<a href='/systems'> Seres sobrenaturales</a> > ";
		...
		switch ($routeKey) {
				...
				if (isset($_GET['s'])) {
					...
					switch ($seccion) {
						case 'admin_pjs':
							...
							break;
						case 'admin_pjs_text':
							echo " > Personajes (TEXT)";
							break;
						case 'admin_pjs_crud':
							echo " > Personajes (CRUD)";
							break;
						case 'admin_groups':
							echo " > Grupos (Manadas & Clanes)";
							break;
						case 'admin_temp':
							echo " > Temporadas";
							break;
			...
			case "seeplayer":	// Ver Jugador
				echo "<a href='/players' title='Lista de Jugadores'>Jugadores</a> > $namePJ $surnamePJ";
				break;
			// ========================================== //
			// Biografías
			// ========================================== //
			case "biogroup":    // Lista de Personajes
				...
				echo "<a href='/characters/types' title='Biografías'>Biografías</a> > $nombreTipo";
				break;
			case "muestrabio":  // Ver Personaje
				// Igual: quitamos afiliación, mostramos Clan > Nombre del PJ
				$typeHref = pretty_url($link, 'dim_character_types', '/characters/type', (int)$bioType);
				echo "<a href='/characters/types' title='Biografías'>Biografías</a> > 
					<a href='" . htmlspecialchars($typeHref) . "'>$nameTipo</a> > $bioName";
				break;
			case "seegroup":	// Ver Organización
				echo "<a href='/organizations' title='Grupos y Sociedades'>Grupos y Sociedades</a> > $packNavLinks";
				break;
			// ========================================== //
			// Archivo
			// ========================================== //
			case "seechapter":	// Ver Capitulo
				...
				echo "<a href='" . htmlspecialchars($tempHref) . "' title='$nameTemporada'>$nameTemporada</a> > Capítulo $numeracionOK";
				break;
			// ========================================== //
			// Documentos
			// ========================================== //
			case "verdoc":	// Ver Documento
				echo "<a href='/documents' title='Documentos'>Documentos</a> > $titleDoc";
				break;
			// ========================================== //
			// Inventario
			// ========================================== //
			case "verobj":
				echo "<a href='/inventory/items' title='Inventario'>Inventario</a> > $itemName";
				break;
			case "seeitem":	// Ver Objeto
				echo "<a href='/inventory/type/$itemType' title='Inventario ($nameTypeBack)'>$nameTypeBack</a> > $itemName";
				break;
			// ========================================== //
			// Sistemas
			// ========================================== //
			...
			case "verforma":	// Ver Forma Cambiante
				...
				echo "{$systemSeresSobrenaturales}<a href='" . htmlspecialchars($sysHref) . "'> $returnType</a> > Forma $nameWereForm";
				break;
			case "versistdetalle":
				$sysHref = pretty_url($link, 'dim_systems', '/systems', (int)$returnTypeId);
				echo "{$systemSeresSobrenaturales}<a href='" . htmlspecialchars($sysHref) . "'> $returnType</a> > $nameSyst";
				break;
			/*
			case "verforma":	// Ver Forma Cambiante
			...
			*/
			...
			// ========================================== //
			case "verrasgo":
				echo "<a href='/rules/traits' title='Rasgos'>Rasgos</a> > $nameSkill";
				break;
			// ========================================== //
			// Méritos y Defectos
			// ========================================== //
			case "vermyd":
				echo "<a href='/rules/merits-flaws' title='Méritos y Defectos'>Méritos y Defectos</a> > $mafName";
				break;
			// ========================================== //
			// Maniobras de Combate
			// ========================================== //
			case "vermaneu":	// Ver Maniobra
				echo "<a href='/rules/maneuvers' title='Maniobras'>Maniobras</a> > $maneName";
				break;
			// ========================================== //
			// Arquetipos de Personalidad
			// ========================================== //
			case "verarch":		// Ver Arquetipo
				echo "<a href='/rules/archetypes' title='Arquetipos de personalidad'>Arquetipos de personalidad</a> > $archeName";
				break;
			// ========================================== //
			// Dones
			// ========================================== //
			...
			case "tipodon":		// Lista de Dones
				echo "<a href='/powers/gifts' title='Dones'>Dones</a> > $routeLabel";
				break;
			case "muestradon":	// Ver Don
				$typeHref = pretty_url($link, 'dim_gift_types', '/powers/gift/type', $donTypeNav);
				echo "<a href='/powers/gifts' title='Dones'>Dones</a> > <a href='" . htmlspecialchars($typeHref) . "' title='$nombreTipo'>$nombreTipo</a> > $donName";
				break;
			// ========================================== //
			// Rituales
			// ========================================== //
			case "tiporite":	// Lista de Rituales
				echo "<a href='/powers/rites' title='Rituales'>Rituales</a> > $routeLabel";
				break;
			case "seerite":		// Ver Ritual
				$typeHref = pretty_url($link, 'dim_rite_types', '/powers/rite/type', $riteTypeNav);
				echo "<a href='/powers/rites' title='Rituales'>Rituales</a> > <a href='" . htmlspecialchars($typeHref) . "' title='$nombreTipo'>$nombreTipo</a> > $riteName";
				break;
			// ========================================== //
			// Tótems
			// ========================================== //
			case "tipototm":	// Lista de Tótems
				echo "<a href='/powers/totems' title='Tótems'>Tótems</a> > $totemName";
				break;
			case "muestratotem":// Ver Tótem
				$typeHref = pretty_url($link, 'dim_totem_types', '/powers/totem/type', $totemTypeNav);
				echo "<a href='/powers/totems' title='Tótems'>Tótems</a> > <a href='" . htmlspecialchars($typeHref) . "' title='$nombreTipo'>$nombreTipo</a> > $totemName";
				break;
			// ========================================== //
			// Disciplinas
			// ========================================== //
			case "tipodisc":	// Lista de Disciplinas
				echo "<a href='/powers/disciplines' title='Disciplinas'>Disciplinas</a> > $routeLabel";
				break;
			case "muestradisc":	// Ver Disciplina
				$typeHref = pretty_url($link, 'dim_discipline_types', '/powers/discipline/type', $donTypeNav);
				echo "<a href='/powers/disciplines' title='Disciplinas'>Disciplinas</a> > <a href='" . htmlspecialchars($typeHref) . "' title='$nombreTipo'>$nombreTipo</a> > $donName";
				break;
			// ========================================== //
			// Simulador de Combate
			// ========================================== //
			case "simulador2":	// Resultado del Combate
				echo "<a href='?p=simulador' title='Simulador de Combate'>Simulador</a> > $nombreCom1 VS $nombreCom2";
				break;
			case "combtodo":	// Lista de Combates
				echo "<a href='?p=simulador' title='Simulador de Combate'>Simulador</a> > Registro de Combates";
				break;
			case "vercombat":	// Ver Combate
				echo "<a href='?p=simulador' title='Simulador de Combate'>Simulador</a> > <a href='?p=combtodo' title='Registro de Combates'>Registro de Combates</a> > Combate #$idDelCombate";
				break;
			case "punts":		// Tabla de Puntuaciones
				echo "<a href='?p=simulador' title='Simulador de Combate'>Simulador</a> > Puntuaciones";
				break;
			case "arms":		// Tabla de Armas
				echo "<a href='?p=simulador' title='Simulador de Combate'>Simulador</a> > Listado de Armas";
				break;
			// ========================================== //
			default:
				//echo "&nbsp;";

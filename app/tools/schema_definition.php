...
return array (
  ...
  `energy_resources_configured` tinyint(1) NOT NULL DEFAULT 0,
  `description` longtext NOT NULL,
  ...
  UNIQUE KEY `uniq_pretty_id` (`pretty_id`)
    ...
    1010 => 
    array (
      'name' => 'dim_organization_departments',
      'create_sql' => 'CREATE TABLE `dim_organization_departments` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `organization_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `chk_dim_org_dept_level` CHECK (`hierarchy_level` between 0 and 99)
    ...
    1011 => 
    array (
      'name' => 'bridge_characters_org',
      'create_sql' => 'CREATE TABLE `bridge_characters_org` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `character_id` int(10) unsigned NOT NULL,
  `organization_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `fk_fact_trait_sets_system` FOREIGN KEY (`system_id`) REFERENCES `dim_systems` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
    ...
    87 => 
    array (
      'name' => 'bridge_breeds_energy_resources',
      'create_sql' => 'CREATE TABLE `bridge_breeds_energy_resources` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `breed_id` int(10) unsigned NOT NULL,
  `resource_id` int(10) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_bridge_breeds_energy_resources_detail_resource` (`breed_id`,`resource_id`),
  KEY `idx_bridge_breeds_energy_resources_detail` (`breed_id`),
  KEY `idx_bridge_breeds_energy_resources_resource` (`resource_id`),
  KEY `idx_bridge_breeds_energy_resources_active_sort` (`is_active`,`sort_order`),
  CONSTRAINT `fk_brer_breed` FOREIGN KEY (`breed_id`) REFERENCES `dim_breeds` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_brer_resource` FOREIGN KEY (`resource_id`) REFERENCES `dim_systems_resources` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;',
    ),
    88 => 
    array (
      'name' => 'bridge_auspices_energy_resources',
      'create_sql' => 'CREATE TABLE `bridge_auspices_energy_resources` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `auspice_id` int(10) unsigned NOT NULL,
  `resource_id` int(10) unsigned NOT NULL,
  `energy_value` int(11) NOT NULL DEFAULT 0,
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_bridge_auspices_energy_resources_detail_resource` (`auspice_id`,`resource_id`),
  KEY `idx_bridge_auspices_energy_resources_detail` (`auspice_id`),
  KEY `idx_bridge_auspices_energy_resources_resource` (`resource_id`),
  KEY `idx_bridge_auspices_energy_resources_active_sort` (`is_active`,`sort_order`),
  CONSTRAINT `fk_baer_auspice` FOREIGN KEY (`auspice_id`) REFERENCES `dim_auspices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_baer_resource` FOREIGN KEY (`resource_id`) REFERENCES `dim_systems_resources` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;',
    ),
    89 => 
    array (
      'name' => 'bridge_tribes_energy_resources',
      'create_sql' => 'CREATE TABLE `bridge_tribes_energy_resources` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `tribe_id` int(10) unsigned NOT NULL,
  `resource_id` int(10) unsigned NOT NULL,
  `energy_value` int(11) NOT NULL DEFAULT 0,
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_bridge_tribes_energy_resources_detail_resource` (`tribe_id`,`resource_id`),
  KEY `idx_bridge_tribes_energy_resources_detail` (`tribe_id`),
  KEY `idx_bridge_tribes_energy_resources_resource` (`resource_id`),
  KEY `idx_bridge_tribes_energy_resources_active_sort` (`is_active`,`sort_order`),
  CONSTRAINT `fk_bter_tribe` FOREIGN KEY (`tribe_id`) REFERENCES `dim_tribes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_bter_resource` FOREIGN KEY (`resource_id`) REFERENCES `dim_systems_resources` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;',
    ),
    90 => 
    array (
      'name' => 'bridge_misc_systems_energy_resources',
      'create_sql' => 'CREATE TABLE `bridge_misc_systems_energy_resources` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `misc_system_id` int(10) unsigned NOT NULL,
  `resource_id` int(10) unsigned NOT NULL,
  `energy_value` int(11) NOT NULL DEFAULT 0,
  `sort_order` int(11) NOT NULL DEFAULT 0,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_bridge_misc_systems_energy_resources_detail_resource` (`misc_system_id`,`resource_id`),
  KEY `idx_bridge_misc_systems_energy_resources_detail` (`misc_system_id`),
  KEY `idx_bridge_misc_systems_energy_resources_resource` (`resource_id`),
  KEY `idx_bridge_misc_systems_energy_resources_active_sort` (`is_active`,`sort_order`),
  CONSTRAINT `fk_bmser_misc_system` FOREIGN KEY (`misc_system_id`) REFERENCES `fact_misc_systems` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_bmser_resource` FOREIGN KEY (`resource_id`) REFERENCES `dim_systems_resources` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;',
    ),
  ),
  'views' => 

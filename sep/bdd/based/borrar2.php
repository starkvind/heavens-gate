...
mysql_query("DELETE FROM pjs1 WHERE nombre = '$nombre'", $link);
mysql_query("DELETE FROM punkte WHERE nombre = '$nombre'", $link);

?>

<br>

<center> <?php echo "Se ha borrado el personaje ' $nombre '"; ?> 

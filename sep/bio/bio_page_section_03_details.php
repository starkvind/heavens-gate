<?php
	...
	if ($bioTheme != "" && $bioThemeUrl != "") { // Colocamos el tema musical del PJ
		echo "<div class='bioRenglonData'>";
			echo"<div class='bioDataName'>Tema:</div>";
			echo"<div class='bioDataText'><a href='$bioThemeUrl' target='_new'>$bioTheme</div></a>";
		echo "</div>";
	} 
?>
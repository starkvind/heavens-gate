...
<table class="tmenu">
	...
	<tr>
		<td class="sekzo">
			<div class="ocultable" id="toolsMenu">
				...
				<a href="index.php?p=status"><div class="renglonMenu">Estado</div></a>
    ...
    <tr>
        ...
        <div class="ocultable" id="bioMenu">
            <?php
				echo "<a href='?p=list_table'><div class='renglonMenu'>Lista de personajes</div></a>";
				...
				echo "<div class='renglonMenu' style='border:0; background-color: transparent;'>&nbsp;</div>";
